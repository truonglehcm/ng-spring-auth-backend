...
public class AdminController {
	...
	@GetMapping(URIConstant.ADMIN_MANAGEMENT_USERS)
	...
	@PostMapping(URIConstant.ADMIN_MANAGEMENT_USERS)
	...
	@PutMapping(URIConstant.ADMIN_MANAGEMENT_USERS)
    ...
    @DeleteMapping(URIConstant.ADMIN_MANAGEMENT_USER)
